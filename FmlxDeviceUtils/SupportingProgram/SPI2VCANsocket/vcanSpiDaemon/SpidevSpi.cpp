...
CSpidevSpi::CSpidevSpi(const char* path, uint32_t speedHz):
	m_Path(path), m_SpeedHz(speedHz)
{
	m_Fd = -1;
}
...
int CSpidevSpi::Transfer(char* pBuf, size_t len) const
{
	// printf("transfer :");
